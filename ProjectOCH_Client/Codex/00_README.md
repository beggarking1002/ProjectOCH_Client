...
3. [03_Current_Status_Workflow.md](03_Current_Status_Workflow.md) — 현재 작업 상태, 검증 방법, 작업 규칙
...
- 현재 작업 트리에는 **커밋되지 않은 전투 UI / GameData / 스킬 아이콘 / Addressables 변경**이 있다. 기존 변경을 덮어쓰거나 되돌리지 않는다.
